export const workData = [
  {
    ...
    title: "Handover AI",
    description:
      "A full-stack tool that helps hospital nurses manage patient handovers more safely, combining my healthcare background with AI-generated clinical summaries. Built end-to-end with a focus on real-world usability.",
    image: "/pictures/Handover_AI_screenshot.png",
    liveURL: "https://nurse-handover-tool-nli6.vercel.app/",
    gitHubURL: "https://github.com/Davipol/nurse-handover-tool",
    techStack: [
      "Next.js",
      "Node.js",
      "Express",
  ...
  {
    id: 5,
    title: "Backend News Project",
    description:
      "A fully tested RESTful API powering a news platform, handling articles, users, topics and comments. Written with Express and PostgreSQL, tested with Jest and Supertest.",
    image: "/pictures/backend-project.png",
    liveURL: "https://news-project-p4c3.onrender.com/",
    gitHubURL: "https://github.com/Davipol/backend-nc-news",
